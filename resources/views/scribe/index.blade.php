...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-blueprints-campaigns" class="tocify-header">
                <li class="tocify-item level-1" data-unique="blueprints-campaigns">
                    <a href="#blueprints-campaigns">Blueprints (Campaigns)</a>
                </li>
                                    <ul id="tocify-subheader-blueprints-campaigns" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="blueprints-campaigns-GETapi-blueprints">
                                <a href="#blueprints-campaigns-GETapi-blueprints">List blueprints</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="blueprints-campaigns-POSTapi-blueprints">
                                <a href="#blueprints-campaigns-POSTapi-blueprints">Create a blueprint</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="blueprints-campaigns-GETapi-blueprints--id-">
                                <a href="#blueprints-campaigns-GETapi-blueprints--id-">Show a blueprint</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="blueprints-campaigns-PUTapi-blueprints--id-">
                                <a href="#blueprints-campaigns-PUTapi-blueprints--id-">Update a blueprint</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="blueprints-campaigns-DELETEapi-blueprints--id-">
                                <a href="#blueprints-campaigns-DELETEapi-blueprints--id-">Delete a blueprint</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="content-generation">
                    <a href="#content-generation">Content Generation</a>
                                    ...
                                    <ul id="tocify-subheader-content-generation" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="content-generation-GETapi-content">
                                <a href="#content-generation-GETapi-content">List raw contents</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="content-generation-GETapi-content--rawContent_id-">
                                <a href="#content-generation-GETapi-content--rawContent_id-">Show a raw content</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="generated-posts">
                    <a href="#generated-posts">Generated Posts</a>
                                ...
                                <a href="#generated-posts-GETapi-posts">List generated posts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="generated-posts-GETapi-posts--generatedPost_id-">
                                <a href="#generated-posts-GETapi-posts--generatedPost_id-">Show a generated post</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="generated-posts-PATCHapi-posts--generatedPost_id--status">
                                <a href="#generated-posts-PATCHapi-posts--generatedPost_id--status">Update post status</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-ghostwriter-assistant" class="tocify-header">
                <li class="tocify-item level-1" data-unique="ghostwriter-assistant">
                    <a href="#ghostwriter-assistant">Ghostwriter Assistant</a>
                </li>
                                    <ul id="tocify-subheader-ghostwriter-assistant" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="ghostwriter-assistant-POSTapi-posts--generatedPost_id--chat">
                                <a href="#ghostwriter-assistant-POSTapi-posts--generatedPost_id--chat">Chat about a generated post</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="blueprints-campaigns">Blueprints (Campaigns)</h1>

    <p>Manage the strict style rules (tone, hashtag limits, character limits,
audience) that drive the AI generation for a user's content.</p>

                                <h2 id="blueprints-campaigns-GETapi-blueprints">List blueprints</h2>

<p>
</p>

<p>Returns the authenticated user's blueprints, each with the number of
posts generated from it (via a single withCount query — no N+1).</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="blueprints-campaigns-POSTapi-blueprints">Create a blueprint</h2>
...
<div class="bash-example">
    ...
    --data "{
    \"name\": \"Tech Community Voice\",
    \"tone\": \"professionnel mais décontracté\",
    \"max_hashtags\": 1,
    \"max_characters\": 280,
    \"target_audience\": \"développeurs backend\",
    \"style_rules\": \"Pas d\'emojis, jamais de superlatifs.\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Tech Community Voice"
               data-component="body">
    <br>
<p>Example: <code>Tech Community Voice</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="professionnel mais décontracté"
               data-component="body">
    <br>
<p>Example: <code>professionnel mais décontracté</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>1-280. Example: <code>280</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="développeurs backend"
               data-component="body">
    <br>
<p>Example: <code>développeurs backend</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="style_rules"                data-endpoint="POSTapi-blueprints"
               value="Pas d'emojis, jamais de superlatifs."
               data-component="body">
    <br>
<p>Example: <code>Pas d'emojis, jamais de superlatifs.</code></p>
        </div>
        </form>

                    <h2 id="blueprints-campaigns-GETapi-blueprints--id-">Show a blueprint</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/blueprints/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/blueprints/16"
);
...
<p>The ID of the blueprint. Example: <code>16</code></p>
                    ...
                    <h2 id="blueprints-campaigns-PUTapi-blueprints--id-">Update a blueprint</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 280. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>target_audience</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="style_rules"                data-endpoint="PUTapi-blueprints--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="blueprints-campaigns-DELETEapi-blueprints--id-">Delete a blueprint</h2>
...
<p>The ID of the blueprint. Example: <code>16</code></p>
    ...
    <p>Submit raw developer notes and monitor their asynchronous transformation
into structured X (Twitter) posts.</p>

                                <h2 id="content-generation-GETapi-content">List raw contents</h2>

<p>
</p>

<p>Returns the authenticated user's raw contents with their generated post
(if any), newest first. Uses eager loading to avoid N+1 queries.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="content-generation-GETapi-content--rawContent_id-">Show a raw content</h2>

<p>
</p>

<p>Returns a single raw content with its generation status and, once ready,
the generated post.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/content/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the rawContent. Example: <code>16</code></p>
            </div>
                    </form>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>List generated posts and manage their editorial lifecycle
(draft, posted, archived).</p>

                                <h2 id="generated-posts-GETapi-posts">List generated posts</h2>

<p>
</p>

<p>Returns every post generated from the authenticated user's raw contents,
newest first. Eager loads the parent raw content to avoid N+1 queries.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="generated-posts-GETapi-posts--generatedPost_id-">Show a generated post</h2>
...
<p>The ID of the generatedPost. Example: <code>16</code></p>
                    ...
                    <h2 id="generated-posts-PATCHapi-posts--generatedPost_id--status">Update post status</h2>

<p>
</p>

<p>Moves a generated post through the editorial calendar.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: draft, posted, archived. Example: <code>posted</code></p>
        </div>
        </form>

                <h1 id="ghostwriter-assistant">Ghostwriter Assistant</h1>

    <p>A contextual chat agent (Couche 2) that reworks a generated post. It uses
real PHP tools to read the database and remembers the conversation across
turns via the SDK persistence tables.</p>

                                <h2 id="ghostwriter-assistant-POSTapi-posts--generatedPost_id--chat">Chat about a generated post</h2>

<p>
</p>

<p>Sends a natural-language message to the Ghostwriter agent for a given post.
Omit conversation_id to start a new conversation; pass the returned
conversation_id back on the next request to keep context.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The post to discuss. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Donne-moi 3 variantes plus agressives pour le hook."
               data-component="body">
    <br>
<p>The user's question or instruction. Example: <code>Donne-moi 3 variantes plus agressives pour le hook.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="conversation_id"                data-endpoint="POSTapi-posts--generatedPost_id--chat"
               value="9b1c..."
               data-component="body">
    <br>
<p>The conversation UUID to continue. Example: <code>9b1c...</code></p>
        </div>
        </form>
